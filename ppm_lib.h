 ...
 */
     ...
     */
    PPM_IMG* ppmNew      (int w, int h, int rng, int nbColors); //deco
     ...
     *                  call to the ppm_lib functions. The memory free is performed during the call of @c ppmClose().
     */
    PPM_IMG* ppmOpen     (char* path); //comp
     ...
     */
    int      ppmRead     (PPM_IMG* img, int x, int y); //comp
     ...
     * @return          nothing.
     */
    void     ppmWrite    (PPM_IMG* img, int x, int y, int value); //decom
     ...
     * @return          nothing.
     */
    void     ppmSave     (PPM_IMG* img, char* path); //decom
    ...
    /*!
	* @brief	 This function compress a PPM image into a txt file.
	*
	* @return	 A text file named "<PPM image name>_compress.txt"
    */
    void compress();
    
    /*!
	* @brief 	This function uncompress a text file named "<name>compress.txt" 	
	*
	* @return 	A PPM image named "<name>.ppm"
     */
    void decompress();
    
    /*!
	* @brief	This function calculates the compression ratio of the PPM image
    *
    * @param nom_ppm	 the name of the PPM image.
    * @param nom_ppm	 the name of the compressed image.
    * @return	 a float corresponding to the compression rate.
    */
